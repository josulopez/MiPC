"""
Django settings for MiPC project.
...
SECRET_KEY = 'django-insecure-qt$ktohlv)!49n+uda&ll3@1=ti@sl@%b3=0#+lo143*#6q4a9'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'Tablas.context_processors.carrito_count',
            ],
        },
    },
]

WSGI_APPLICATION = 'MiPC.wsgi.application'
